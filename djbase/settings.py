...
# Absolute filesystem path to the parent of top-level project folder:
SITE_PARENT_DIR = dirname(SITE_ROOT)
...
SECRET_KEY = 'ie(21g4s%b3o#ovu-l+xqljrw#$6e(yl7hl15$v4_#m$+1+hti'
